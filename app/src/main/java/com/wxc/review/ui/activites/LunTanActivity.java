...
import com.wxc.review.adapter.ForumListAdapter;
    ...
    private void initView() {
        ...
        pullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(LunTanActivity.this, InvitationActivity.class);
    ...
    private void quaryInvitationsFromBmob() {
        ...
        bmobQuery.findObjects(this, new FindListener<Invitation>() {
            ...
            public void onSuccess(List<Invitation> list) {
                ...
                if (LunTanActivity.this.list==null) {
                    LunTanActivity.this.list = list;//赋值给当前的集合，
                    forumListAdapter = new ForumListAdapter(LunTanActivity.this, list);
                    pullToRefreshListView.setAdapter(forumListAdapter);
                    forumListAdapter.notifyDataSetChanged();//只设置一次adapter的情况适用
                }else{
                    for (Invitation invitation:list) {
                        LunTanActivity.this.list.add(invitation);//添加到集合中
                    }
                    forumListAdapter.notifyDataSetChanged();//只设置一次adapter的情况适用
                }
